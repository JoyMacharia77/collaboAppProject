...
//import com.joymacharia.collaboapp.Adapters.AccountPostAdapter;
...
import de.hdodenhof.circleimageview.CircleImageView;
    ...
    public class AccountFragment extends Fragment {
        ...
        private TextView txtName, txtPostsCount,email;
...
//            arrayList = new ArrayList<>();
        ...
        private void logout() {
            StringRequest request = new StringRequest(Request.Method.GET, constants.LOGOUT, res -> {
