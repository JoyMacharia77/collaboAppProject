...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private boolean validate() {
        ...
        (txtName.getText().toString().isEmpty()){
            ...
            layoutName.setError(" Name Field cannot be blank");
            return false;
        }
        //remember to change this to 8
        if(txtLastName.getText().toString().isEmpty()){
            layoutLastName.setErrorEnabled(true);
            layoutLastName.setError(" last Name field cannot be blank");
            return false;
        }
    ...
    private void saveUserInfo(){
        ...
        String mURL = "http://192.168.8.105/api/save_user_info";
